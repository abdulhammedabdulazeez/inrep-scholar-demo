...
const collaborations = [
  {
    ...
    description:
      "Collaborative research on machine learning applications for sustainable farming practices in Rwanda.",
  ...
  },
  {
    ...
    institution: "African Leadership University",
    description:
      "Joint publication on blockchain technology adoption in African financial ecosystems.",
  ...
  },
  {
    ...
    description:
      "Cross-institutional research on water management solutions for urban development.",
...
export default function CollaborationPage() {
  ...
  const getTypeBadge = (type: string) => {
    ...
    const config =
      ...
      typeConfig["Research Partnership"];
    return (
      <span
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Welcome Section */}
        <div className="bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-lg p-8 mb-8">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold mb-4">
              🤝 Research Collaboration Hub
            </h2>
            <p className="text-blue-100 text-lg mb-6">
              Connect with researchers across Africa, form partnerships, and
              collaborate on groundbreaking research projects. Share knowledge,
              co-author publications, and build lasting academic relationships.
            </p>
            <button
                  ...
                  <div className="flex items-center justify-between border-t pt-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <span className="text-sm text-gray-600">
                        ...
                        {collab.members.length > 2 &&
                          ` and ${collab.members.length - 2} others`}
                      </span>
                    </div>
              ...
              {availablePartners.map((partner) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="h-16 w-16 bg-linear-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                      {partner.name
                        .split(" ")
                        .map((n) => n[0])
                        .join("")}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Share drafts, data, and research materials securely with
              ...
              <div className="bg-white rounded-lg shadow border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Collaborate on manuscripts with real-time editing, comments,
                    and version control.
                  </p>
              ...
              <div className="bg-white rounded-lg shadow border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Schedule and host virtual meetings with integrated screen
              ...
              <div className="bg-white rounded-lg shadow border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Track progress, assign tasks, and manage deadlines for your
                    research projects.
                  </p>
              ...
              <div className="bg-white rounded-lg shadow border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Share datasets, analysis tools, and research methodologies
                    with your team.
                  </p>
              ...
              <div className="bg-white rounded-lg shadow border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Discover funding opportunities and collaborate on grant
                    applications.
                  </p>
