...
const userDocuments = [
  ...
  },
  {
    ...
    abstract:
      "A comprehensive study on IoT sensor deployment for precision agriculture in Rwandan farming systems...",
    fileSize: "1.8 MB",
  ...
  },
  {
    ...
    abstract:
      "Analysis of climate adaptation strategies implemented by smallholder farmers in rural Rwanda...",
    fileSize: "956 KB",
  ...
  },
  {
    ...
    accessRights: "restricted",
    abstract:
      "Exploring blockchain technology applications for secure and transparent land registration systems in Rwanda...",
    fileSize: "3.1 MB",
...
export default function MyDocumentsPage() {
  ...
  const getPlagiarismBadge = (score: number | null) => {
    if (score === null)
      return <span className="text-gray-500 text-sm">Not checked</span>;
