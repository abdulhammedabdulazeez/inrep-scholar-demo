    ...
    <MainLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">University of Rwanda Repository Management</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow border p-6">
            ...
            <div className="space-y-3">
              <Link href="/demo/ur/user/upload" className="flex items-center p-3 border rounded-md hover:bg-gray-50 transition">
              ...
              <Link href="/demo/ur/admin/users" className="flex items-center p-3 border rounded-md hover:bg-gray-50 transition">
              ...
              <Link href="/demo/ur/admin/reviews" className="flex items-center p-3 border rounded-md hover:bg-gray-50 transition">
                <span className="text-xl mr-3">📝</span>
                <div>
