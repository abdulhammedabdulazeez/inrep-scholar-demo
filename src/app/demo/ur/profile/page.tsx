        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center space-x-4">
              <a href="/demo/ur/user" className="text-blue-600 hover:text-blue-800">← Back to Dashboard</a>
            </nav>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow border p-6">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Marie Uwimana</h3>
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-lg shadow border p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <select className="w-full border border-gray-300 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                      <option value="masters" selected>Master's Student</option>
              ...
              <div className="flex justify-end space-x-4">
                <a href="/demo/ur/user" className="px-6 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition">
                  Back to Dashboard
                </a>
